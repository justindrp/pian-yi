...
export default function NewOrderModal({
  ...
  const [orderType, setOrderType] = useState<"recurring" | "scheduled" | null>(
    null,
  );
  ...
  const [schedMeal, setSchedMeal] = useState<"lunch" | "dinner" | "both">(
    "lunch",
  );
  ...
  function openCreateCustomer() {
    ...
    const looksLikePhone =
      /[0-9]/.test(customerSearch) && !/[a-z]/i.test(customerSearch);
    setNewCust({
      name: "",
      phone_number: looksLikePhone ? customerSearch.trim() : "",
      area: "",
      address: "",
      address_2: "",
      subcontractor_id: "",
      ...
      const body =
        orderType === "recurring"
          ? {
              ...
              portions_dinner: portionsDinner
                ? Number(portionsDinner)
                : undefined,
            }
          : {
              ...common,
              ...
              <div className="mt-3 border border-blue-200 bg-blue-50/40 rounded-lg p-3 space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    ...
                    className="text-gray-400 hover:text-gray-600 text-lg leading-none h-auto w-auto p-0"
                  >
                    &times;
                  </Button>
                </div>
                <Input
                  value={newCust.phone_number}
                  onChange={(e) =>
                    setNewCust({ ...newCust, phone_number: e.target.value })
                  }
                  placeholder="Nomor telepon (+628...) *"
                ...
                />
                <Input
                  value={newCust.address_2}
                  onChange={(e) =>
                    setNewCust({ ...newCust, address_2: e.target.value })
                  }
                ...
                <Input
                  value={newCust.area}
                  onChange={(e) =>
                    setNewCust({ ...newCust, area: e.target.value })
                  }
                  placeholder="Area"
                  className="text-sm h-auto"
                />
                <Select
                  value={newCust.subcontractor_id || NO_SUBCONTRACTOR}
                  onValueChange={(v) =>
                    setNewCust({
                      ...newCust,
                      subcontractor_id: v === NO_SUBCONTRACTOR ? "" : v,
                    })
                  }
                >
                  <SelectTrigger className="text-sm h-auto">
                    <SelectValue placeholder="Dapur" />
                  </SelectTrigger>
                  <SelectContent>
                ...
                <Button
                  ...
                  className="w-full py-2 bg-blue-600 text-white text-sm rounded-lg disabled:opacity-40 h-auto"
                >
                  {creatingBusy ? "Menyimpan..." : "Buat & pilih"}
                </Button>
              </div>
            )}
          </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <div className="text-xs text-gray-500 mt-0.5">
                  Pilih tanggal sendiri, sekali isi
                </div>
              </Button>
              <Button
                type="button"
              ...
              >
                ...
                <div className="text-xs text-gray-500 mt-0.5">
                  Otomatis tiap hari sampai paket habis
                </div>
              </Button>
            </div>
          </div>
          ...
          {step === 2 && orderType && (
            <>
              ...
              <div className="grid grid-cols-2 gap-3 mb-4">
                <div>
                  <Label
                    htmlFor="new-order-price-per-portion"
                ...
                <div>
                  <Label
                    htmlFor="new-order-portions-per-delivery"
                    className="block text-xs font-medium text-gray-600 mb-1"
                  >
                    Porsi / pengiriman
                  </Label>
                ...
                <div>
                  <Label
                    htmlFor="new-order-subcontractor"
                    className="block text-xs font-medium text-gray-600 mb-1"
                  >
                    Subkontraktor
                  </Label>
                  <Select
                    ...
                    onValueChange={(v) =>
                      setSubcontractorId(v === NO_SUBCONTRACTOR ? "" : v)
                    }
                  >
                    <SelectTrigger
                      id="new-order-subcontractor"
                      className="w-full border-gray-200 rounded-lg px-3 py-2 text-sm h-auto"
                    >
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value={NO_SUBCONTRACTOR}>
                        — Tidak ada —
                      </SelectItem>
                      {subcontractors.map((s) => (
                        <SelectItem key={s.id} value={s.id}>
                ...
                {selectedCustomer?.address_2 && (
                  <div className="col-span-2 border-t pt-3">
                    <p className="block text-xs font-medium text-gray-600 mb-2">
                      Alamat pengiriman per waktu makan
                    </p>
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        ...
                        <div className="flex gap-2">
                          <Button
                            type="button"
                            variant="outline"
                            onClick={() => setLunchSlot(1)}
                            className={`flex-1 px-2 py-1.5 text-xs rounded-lg border h-auto ${lunchSlot === 1 ? "bg-blue-600 text-white border-blue-600" : "border-gray-200 text-gray-700"}`}
                          >
                            Alamat 1
                          </Button>
                          <Button
                            type="button"
                            variant="outline"
                            onClick={() => setLunchSlot(2)}
                            className={`flex-1 px-2 py-1.5 text-xs rounded-lg border h-auto ${lunchSlot === 2 ? "bg-blue-600 text-white border-blue-600" : "border-gray-200 text-gray-700"}`}
                          >
                            Alamat 2
                          </Button>
                        </div>
                      ...
                      <div>
                        ...
                        <div className="flex gap-2">
                          <Button
                            type="button"
                            variant="outline"
                            onClick={() => setDinnerSlot(1)}
                            className={`flex-1 px-2 py-1.5 text-xs rounded-lg border h-auto ${dinnerSlot === 1 ? "bg-blue-600 text-white border-blue-600" : "border-gray-200 text-gray-700"}`}
                          >
                            Alamat 1
                          </Button>
                          <Button
                            type="button"
                            variant="outline"
                            onClick={() => setDinnerSlot(2)}
                            className={`flex-1 px-2 py-1.5 text-xs rounded-lg border h-auto ${dinnerSlot === 2 ? "bg-blue-600 text-white border-blue-600" : "border-gray-200 text-gray-700"}`}
                          >
                            Alamat 2
                          </Button>
                        </div>
                    ...
                    <p className="text-[11px] text-gray-400 mt-1.5">
                      Alamat 2: {selectedCustomer.address_2}
                    </p>
                  </div>
                )}
              </div>
              ...
              {orderType === "recurring" && (
                <div className="grid grid-cols-2 gap-3 mb-4 border-t pt-4">
                  ...
                  <div>
                    <Label
                      htmlFor="new-order-package-size"
                      className="block text-xs font-medium text-gray-600 mb-1"
                    >
                      Total porsi (package size)
                    </Label>
                    <Input
                  ...
                  {mealPref === "both_fixed" && (
                    <>
                      <div>
                        <Label
                          htmlFor="new-order-portions-lunch"
                          className="block text-xs font-medium text-gray-600 mb-1"
                        >
                          Porsi lunch
                        </Label>
                      ...
                      <div>
                        <Label
                          htmlFor="new-order-portions-dinner"
                          className="block text-xs font-medium text-gray-600 mb-1"
                        >
                          Porsi dinner
                        </Label>
                  ...
                  <div className="col-span-2">
                    ...
                    <div className="flex gap-2">
                      <Button
                        ...
                        variant="outline"
                        onClick={() => setSize("s")}
                        className={`px-4 py-2 text-sm rounded-lg border h-auto ${size === "s" ? "bg-blue-600 text-white border-blue-600" : "border-gray-200 text-gray-700"}`}
                      >
                        S (Standar)
                      </Button>
                      <Button
                        ...
                        variant="outline"
                        onClick={() => setSize("m")}
                        className={`px-4 py-2 text-sm rounded-lg border h-auto ${size === "m" ? "bg-blue-600 text-white border-blue-600" : "border-gray-200 text-gray-700"}`}
                      >
                        M (+Rp 2.000/porsi)
                      </Button>
                    </div>
                  ...
                  <div className="col-span-2 bg-gray-50 rounded-lg px-3 py-2 text-sm text-gray-600">
                    Total: {packageSize} porsi × Rp{" "}
                    {(
                      Number(pricePerPortion) + (size === "m" ? 2000 : 0)
                ...
                <div className="border-t pt-4 mb-4 space-y-3">
                  ...
                  <div>
                    ...
                    <RadioGroup
                      value={schedMeal}
                      onValueChange={(v) => {
                        setSchedMeal(v as "lunch" | "dinner" | "both");
                        setScheduleGenerated(false);
                      }}
                  ...
                  {schedule.length > 0 && (
                    <>
                      <div className="bg-blue-50 rounded-lg px-3 py-2 text-sm text-gray-700">
                        {schedule.length} pengiriman · {totalPortions} porsi ×
                        Rp {Number(pricePerPortion).toLocaleString("id-ID")} ={" "}
                        <span className="font-semibold text-gray-900">
