...
import { HAIKU_MODEL, NO_THINKING, getAnthropicClient } from "@/lib/claude/client";
...
const INDONESIAN = new Set([
  "kak", "ya", "yang", "saya", "kami", "kita", "untuk", "dan", "di", "ke",
  "dari", "tidak", "nggak", "gak", "sudah", "udah", "belum", "bisa", "akan",
  "dengan", "ini", "itu", "aja", "saja", "nya", "mohon", "maaf", "terima",
  "kasih", "silakan", "pesan", "pesanan", "porsi", "hari", "minggu", "kirim",
  "kirimkan", "ada", "mau", "juga", "atau", "kalau", "biar", "baik", "nanti",
  "dulu", "jam", "harga", "besok", "dapur", "makan", "siang", "malam",
]);

const ENGLISH = new Set([
  "the", "i", "you", "your", "we", "our", "will", "for", "to", "of", "is",
  "are", "and", "please", "send", "check", "sorry", "can", "let", "me", "it",
  "this", "that", "have", "has", "with", "be", "do", "does", "thanks", "here",
  "want", "would", "should", "there", "was", "were", "on", "at", "as", "so",
]);
