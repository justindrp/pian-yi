    ...
    <div className="space-y-4 max-w-2xl">
      <div>
        ...
        <p className="text-sm text-gray-400 mt-1">
          Pian Yi Catering — Admin Dashboard
        </p>
        <p className="text-sm text-gray-500 mt-3">
          Halaman ini soal cara mengklik. Untuk konteks bisnisnya — aturan
          harga, batas waktu, kuota, kerahasiaan dapur — baca{" "}
          <Link
            href="/handbook"
      ...
      <Section title="Pembayaran">
        ...
        />
        <Note>
          Jangan konfirmasi pembayaran sebelum mengecek nominal dan rekening
          tujuan di foto bukti.
        </Note>
      </Section>
      ...
      <Section title="Pesanan">
        ...
        />
        <Note>
          Status pesanan hanya bisa diubah ke arah yang sesuai — pesanan aktif
          tidak bisa langsung ke pending.
        </Note>
      </Section>
      ...
      <Section title="Pengiriman Harian">
        ...
        />
        <Note>
          Tidak ada proses otomatis yang membuat lembar besok setiap sore. Kalau
          tidak ada yang membuka dan memeriksa halaman ini sebelum batas waktu,
          yang hilang dari lembar itu tidak akan ketahuan.
        </Note>
        <Note>
          Lembar pengiriman bisa dibuka dari ponsel — pastikan selalu klik Save
      ...
      <Section title="Pengaturan">
        ...
        />
        <Note>
          Perubahan harga tidak mempengaruhi pesanan yang sudah berjalan — hanya
          berlaku untuk pesanan baru.
        </Note>
      </Section>
