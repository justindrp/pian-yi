...
| no_rice_discount | integer | What the kitchen knocks off **their** per-portion charge to us for a tanpa-nasi box (migration 098). It is a cost column, not a customer discount: nothing prices an order off it, and the customer pays the same either way. Santapin knock off Rp 2.000 — the column said 2.500 until 2026-09-06, which matched neither their cost gap (22.000 with rice, 20.000 without) nor the marked-up version of it. NULL means the kitchen does not sell a box without rice, which is Thenie. **Homey cannot be expressed here and their Rp 4.000 is the least-wrong single value**: their gap moves with how many portions one drop carries — Rp 4.000 at 1 portion, Rp 5.500 at 2, Rp 4.333 at 3, Rp 4.750 at 4, Rp 4.200 at 5 — so a single integer is the wrong shape for them. It held a placeholder Rp 5.000 until 2026-09-06, when Homey's public price card confirmed the ladder; 4.000 is the 1-portion gap, and 78% of drops carry one portion |
