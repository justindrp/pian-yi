...
- **A one-off event order is tendered to the kitchens, never priced off the ladder.** The bot gathers the brief and escalates, and **must not call `extract_order`** — creating the order is what sends the bank details. See `docs/OPERATIONS.md`.
