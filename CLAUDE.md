...
- **Generated multi-day runs still ignore `src/lib/holidays/id.ts`.** The manual fix skipped 25 Agustus (Maulid Nabi) by hand; nothing in `record_daily_order` does. A confirmed Senin–Jumat can still land a row on a tanggal merah.
