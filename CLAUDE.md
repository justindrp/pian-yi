...
- **The 2026-06-08 import invented placeholder orders.** Defi Lugito (`pkg=16`), Valen (`pkg=45`, exactly the sum of her two real orders) and Darren (`pkg=18`) each carry a fabricated order on the WhatsApp row that is in no sheet, while their real purchases sat on the duplicate row. Any bought-vs-drawn figure counting these is wrong. Real: Defi 100 bought / 106 drawn, Valen 45 / 49, Darren 30 / 33 — and Darren's real 30-portion order (Rp 790.000 @ 26.333, 2026-06-02) is still not in the database at all. Darren also held copies of Darren Dior's 10 March deliveries, deleted 2026-08-14.
...
- **Overdraw: 31 customers have drawn 190 more portions than they bought.** No draw path checks the balance before writing. Verick (83), Kiliang (11), Darren Dior (10) and Kevin M (8) have zero purchases on file at all and are the pre-December sheet gap, not grants. The 18 customers overdrawn by only 1–2 portions (24 total) are the missing guard, not deliberate free quota. Free-quota orders for the rest are pending Justin's per-customer verification of what was actually granted — do not create them speculatively.
