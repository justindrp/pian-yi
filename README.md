...
Docs: `CLAUDE.md` (conventions + the rule map, read every session), `docs/BOT_RULES.md` (the WhatsApp chatbot), `docs/OPERATIONS.md` (pricing, orders, deliveries, kitchens), `docs/WHATSAPP.md` (sends, window, webhook), `docs/ADMIN.md` (roles, takeover, Assistant), `docs/DATABASE.md` (schema), `docs/API_ROUTES.md` (endpoints), `docs/DEV_REFERENCE.md` (cost controls, folder tree, tooling).
